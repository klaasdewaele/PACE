...
#                 {'A': 'A6', 'B': 'B2', 'C': 'C4', 'D': 'D0', 'E': 'E2', 'F': 'Z0'}, # Slechts 2u gelopen! Ruwe data nog zoeken in map; nu MICs overgenomen van LWS en vanop foto; klinische TR34 positieve stam!
           ...
           ### DEEL 2
            ...
            'A-95761404 72 scan areas.xlsx':
                {'A': 'A7', 'B': 'B5', 'C': 'C6', 'D': 'D6', 'E': 'E4', 'F': 'F7'}, # McF 0.52; afgelezen 58u - vorico veranderd naar B5 ipv B4, want anders ATU en is verder omni-S - ook te laat afgelezen en S bevestigd door foto               
            'A-CYP-15-224 72 scan areas.xlsx':
                {'A': 'A6', 'B': 'B0', 'C': 'C4', 'D': 'D3', 'E': 'E0', 'F': 'F7'}, # McF 0.35; afgelezen 50u - PLAAT NIET TERUGGEVONDEN - TWIJFEL OLOROFIM? F1 vs F7? Obv foto F7 gemaakt             
            'A-CYP-15-245 72 scan areas.xlsx':
                {'A': 'A6', 'B': 'B3', 'C': 'C4', 'D': 'D0', 'E': 'E2', 'F': 'F6'}, # McF 0.42; afgelezen 33u
            'A-CYP-15-250 72 scan areas.xlsx':
                {'A': 'A6', 'B': 'B0', 'C': 'C4', 'D': 'D0', 'E': 'E0', 'F': 'F6'}, # McF 0.43; afgelezen 47u - pas olorofim hierbij gezet op 28 dec, was eerder onterecht Z0 
            'A-CYP-15-161 72 scan areas.xlsx':
                {'A': 'A6', 'B': 'B0', 'C': 'C5', 'D': 'D6', 'E': 'E0', 'F': 'F7'}, # McF 0.56; afgelezen 56u 
            'A-CYP-15-243 72 scan areas.xlsx':
                {'A': 'A6', 'B': 'B0', 'C': 'C5', 'D': 'D0', 'E': 'E0', 'F': 'F7'}, # McF 0.65; afgelezen na 4d waarvan 2d koelkast
