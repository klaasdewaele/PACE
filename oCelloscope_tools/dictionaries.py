...
MIC_dict_A = {'ASFU_ATCC_204305_S': {'A': 'A6',
                        ...
                        'E': 'E4',
                        'F': 'F3'}, # F3 naar F8
 'ASFU_R_TR34_1': {'A': 'Z0', # Amfo B verwijderd gezien waarschijnlijk uitgevoerd met slecht lot
                   'B': 'B4',
                   'C': 'C5',
                   'D': 'D0',
                   'E': 'E2',
 ...
 'ASFU_R_TR34_11': {'A': 'A7',
                    ...
                    'E': 'E1',
                    'F': 'F9'}, # F9 ipv F5
 'ASFU_R_TR34_12': {'A': 'A7', # A
                    'B': 'B2',
                    'C': 'C4',
                    'D': 'D0',
                    'E': 'E1',
                    'F': 'F6'},
 'ASFU_R_TR34_13': {'A': 'A6', # A
                    'B': 'B2', # B2 ipv B0 iom KL
                    'C': 'C6', # C6 ipv C4
                    'D': 'D0',
                    'E': 'E2', # E2 ipv E0
                    'F': 'Z0'},
 'ASFU_R_TR34_2': {'A': 'A7',
                   ...
                   'E': 'E3',
                   'F': 'F8'},
 'ASFU_R_TR34_3': {'A': 'A6', # A
                   'B': 'B1',
                   'C': 'C4',
                   'D': 'D0',
                   'E': 'E0',
                   'F': 'F5'},
 'ASFU_R_TR34_4': {'A': 'A7', # A
                   'B': 'B2',
                   'C': 'C4',
                   'D': 'D0',
                   'E': 'E2',
 ...
 'ASFU_R_TR46_16': {'A': 'A7',
                    ...
                    'E': 'E2',
                    'F': 'F6'},
 'ASFU_R_TR46_17': {'A': 'A6', # A
                    'B': 'B0',
                    'C': 'C5',
                    'D': 'D6',
                    'E': 'E0',
                    'F': 'F7'},
 'ASFU_R_TR46_17_2': {'A': 'A7',
                      'B': 'B0',
                      'C': 'C5',
                      'D': 'D6',
                      'E': 'E0',
                      'F': 'Z0'},
 'ASFU_R_TR46_17_3': {'A': 'A7',
                      'B': 'B0',
                      'C': 'C5',
                      'D': 'D6',
                      'E': 'E0',
                      'F': 'Z0'},
 'ASFU_R_TR46_18': {'A': 'A6', # A
                    'B': 'B0',
                    'C': 'C0', # C0 naar C3
                    'D': 'D0',
                    'E': 'E0',
 ...
 'ASFU_S_2': {'A': 'A6', 'B': 'B6', 'C': 'C7', 'D': 'D6', 'E': 'E6', 'F': 'Z0'}, # B0 naar B6, D0 naar D6, E0 naar E6
 'ASFU_S_3': {'A': 'A7', 'B': 'B6', 'C': 'C7', 'D': 'D6', 'E': 'E4', 'F': 'F7'},
 'ASFU_S_4': {'A': 'A6', 'B': 'B6', 'C': 'C8', 'D': 'D7', 'E': 'E5', 'F': 'Z0'}, # A # B6 ipv B0, C8 ipv C0, E5 ipv E0
 'ASFU_S_5': {'A': 'A7', 'B': 'B6', 'C': 'C8', 'D': 'D8', 'E': 'E6', 'F': 'F8'},
 'ASFU_S_6': {'A': 'A7', 'B': 'B5', 'C': 'C6', 'D': 'D6', 'E': 'E4', 'F': 'F7'}, # A
 'ASFU_S_7': {'A': 'A7', 'B': 'B6', 'C': 'C8', 'D': 'D8', 'E': 'E5', 'F': 'F8'}}

# This is MIC dict used for original calculations based on visual read-out
#MIC_dict_A = {'ASFU_R_TR34_1': {'A': 'A5', 'B': 'B4', 'C': 'C5', 'D': 'D0', 'E': 'E2', 'F': 'Z0'}, 'ASFU_S_1': {'A': 'A8', 'B': 'B7', 'C': 'C7', 'D': 'D8', 'E': 'E6', 'F': 'F8'}, 'ASFU_R_TR34_2': {'A': 'A7', 'B': 'B4', 'C': 'C5', 'D': 'D0', 'E': 'E2', 'F': 'F7'}, 'ASFU_R_TR46_18': {'A': 'A6', 'B': 'B0', 'C': 'C3', 'D': 'D0', 'E': 'E0', 'F': 'Z0'}, 'ASFU_ATCC_204305_S': {'A': 'A7', 'B': 'B7', 'C': 'C9', 'D': 'D9', 'E': 'E6', 'F': 'F9'}, 'ASFU_R_TR34_3': {'A': 'A6', 'B': 'B2', 'C': 'C4', 'D': 'D0', 'E': 'E1', 'F': 'F7'}, 'ASFU_R_TR34_4': {'A': 'A7', 'B': 'B2', 'C': 'C4', 'D': 'D0', 'E': 'E1', 'F': 'F8'}, 'ASFU_R_TR34_5': {'A': 'A7', 'B': 'B3', 'C': 'C5', 'D': 'D0', 'E': 'E2', 'F': 'F7'}, 'ASFU_R_TR34_6': {'A': 'A6', 'B': 'B3', 'C': 'C4', 'D': 'D0', 'E': 'E2', 'F': 'F6'}, 'ASFU_R_TR34_7': {'A': 'A7', 'B': 'B3', 'C': 'C5', 'D': 'D0', 'E': 'E2', 'F': 'F6'}, 'ASFU_R_TR34_8': {'A': 'A8', 'B': 'B4', 'C': 'C5', 'D': 'D0', 'E': 'E2', 'F': 'F8'}, 'ASFU_R_TR34_9': {'A': 'A7', 'B': 'B3', 'C': 'C4', 'D': 'D0', 'E': 'E2', 'F': 'F8'}, 'ASFU_R_TR34_10': {'A': 'A8', 'B': 'B4', 'C': 'C5', 'D': 'D0', 'E': 'E3', 'F': 'F8'}, 'ASFU_R_TR34_11': {'A': 'A7', 'B': 'B3', 'C': 'C4', 'D': 'D0', 'E': 'E3', 'F': 'F9'}, 'ASFU_R_TR34_12': {'A': 'A7', 'B': 'B1', 'C': 'C4', 'D': 'D0', 'E': 'E1', 'F': 'F6'}, 'ASFU_S_8': {'A': 'A7', 'B': 'B5', 'C': 'C6', 'D': 'D6', 'E': 'E5', 'F': 'Z0'}, 'ASFU_S_2': {'A': 'A6', 'B': 'B6', 'C': 'C7', 'D': 'D6', 'E': 'E6', 'F': 'Z0'}, 'ASFU_R_TR46_14': {'A': 'A6', 'B': 'B0', 'C': 'C6', 'D': 'D0', 'E': 'E0', 'F': 'Z0'}, 'ASFU_R_TR34_13': {'A': 'A6', 'B': 'B2', 'C': 'C6', 'D': 'D0', 'E': 'E2', 'F': 'Z0'}, 'ASFU_R_unknown_22': {'A': 'A6', 'B': 'B0', 'C': 'C4', 'D': 'D6', 'E': 'E0', 'F': 'Z0'}, 'ASFU_S_3': {'A': 'A7', 'B': 'B6', 'C': 'C7', 'D': 'D7', 'E': 'E5', 'F': 'F7'}, 'ASFU_S_4': {'A': 'A6', 'B': 'B6', 'C': 'C8', 'D': 'D7', 'E': 'E5', 'F': 'Z0'}, 'ASFU_R_TR46_19': {'A': 'A6', 'B': 'B0', 'C': 'C4', 'D': 'D4', 'E': 'E0', 'F': 'F8'}, 'ASFU_S_7': {'A': 'A7', 'B': 'B5', 'C': 'C7', 'D': 'D8', 'E': 'E5', 'F': 'F7'}, 'ASFU_S_5': {'A': 'A7', 'B': 'B6', 'C': 'C8', 'D': 'D8', 'E': 'E5', 'F': 'F6'}, 'ASFU_S_6': {'A': 'A7', 'B': 'B4', 'C': 'C6', 'D': 'D6', 'E': 'E4', 'F': 'F7'}, 'ASFU_R_TR46_15': {'A': 'A6', 'B': 'B0', 'C': 'C4', 'D': 'D3', 'E': 'E0', 'F': 'F7'}, 'ASFU_R_TR46_16': {'A': 'A6', 'B': 'B3', 'C': 'C4', 'D': 'D0', 'E': 'E2', 'F': 'F6'}, 'ASFU_R_TR46_20': {'A': 'A6', 'B': 'B0', 'C': 'C4', 'D': 'D0', 'E': 'E0', 'F': 'Z0'}, 'ASFU_R_TR46_17': {'A': 'A6', 'B': 'B0', 'C': 'C5', 'D': 'D6', 'E': 'E0', 'F': 'F7'}, 'ASFU_R_TR46_21': {'A': 'A6', 'B': 'B0', 'C': 'C5', 'D': 'D0', 'E': 'E0', 'F': 'F7'}, 'ASFU_R_23': {'A': 'A6', 'B': 'B2', 'C': 'C5', 'D': 'D0', 'E': 'E2', 'F': 'Z0'}}

name_map = {'A-ATCC-204305 72 scan areas.xlsx': 'ASFU_ATCC_204305_S', 'A-93624221 72 scan areas.xlsx': 'ASFU_S_1', 'A-94943434 60 scan areas.xlsx': 'ASFU_S_2', 'A-96043965 72 scan areas.xlsx': 'ASFU_S_3', 'A-95746873 60 scan areas.xlsx': 'ASFU_S_4', 'A-95551158 72 scan areas.xlsx': 'ASFU_S_5', 'A-95761404 72 scan areas.xlsx': 'ASFU_S_6', 'A-95707146 72 scan areas.xlsx': 'ASFU_S_7', 'A-94991776 60 scan areas.xlsx': 'ASFU_S_8', 'A-94329739 60 scan areas.xlsx': 'ASFU_R_TR34_1', 'A-94512364 60 scan areas.xlsx': 'ASFU_R_TR34_2', 'A-CYP-15-232 72 scan areas.xlsx': 'ASFU_R_TR34_3', 'A-CYP-15-183 72 scan areas.xlsx': 'ASFU_R_TR34_4', 'A-CYP-15-234 72 scan areas.xlsx': 'ASFU_R_TR34_5', 'A-CYP-15-229 72 scan areas.xlsx': 'ASFU_R_TR34_6', 'A-CYP-15-202 72 scan areas.xlsx': 'ASFU_R_TR34_7', 'A-CYP-15-231 96 scan areas.xlsx': 'ASFU_R_TR34_8', 'A-CYP-15-235 96 scan areas.xlsx': 'ASFU_R_TR34_9', 'A-CYP-15-207 96 scan areas.xlsx': 'ASFU_R_TR34_10', 'A-CYP-15-208 96 scan areas.xlsx': 'ASFU_R_TR34_11', 'A-CYP-15-198 72 scan areas.xlsx': 'ASFU_R_TR34_12', 'A-96584145 60 scan areas.xlsx': 'ASFU_R_TR34_13', 'A-CYP-15-193 60 scan areas.xlsx': 'ASFU_R_TR46_14', 'A-CYP-15-224 72 scan areas.xlsx': 'ASFU_R_TR46_15', 'A-CYP-15-245 72 scan areas.xlsx': 'ASFU_R_TR46_16', 'A-CYP-15-161 72 scan areas.xlsx': 'ASFU_R_TR46_17', 'A-94647258 60 scan areas.xlsx': 'ASFU_R_TR46_18', 'A-CYP-15-209 72 scan areas.xlsx': 'ASFU_R_TR46_19', 'A-CYP-15-250 72 scan areas.xlsx': 'ASFU_R_TR46_20', 'A-CYP-15-243 72 scan areas.xlsx': 'ASFU_R_TR46_21', 'A-96264824 60 scan areas.xlsx': 'ASFU_R_unknown_22', 'A-94939738 60 scan areas.xlsx': 'ASFU_R_23', 'C-B8441-AR387 96 scan areas.xlsx': 'CDAU_CDC_clade_I', 'C-B11220-AR381 96 scan areas.xlsx': 'CDAU_CDC_clade_II', 'C-MRU224 96 scan areas.xlsx': 'CDAU_clinical_clade_III', 'C-MCC3-10 96 scan areas.xlsx': 'CDAU_clinical_clade_IV', 'C-ML315-AR1037 96 scan areas.xlsx': 'CDAU_CDC_clade_V', 'C-Dhondt 96 scan areas.xlsx': 'CDAU_clinical_1', 'C-Alkandri2 96 scan areas.xlsx': 'CDAU_clinical_2', 'C-Enam 96 scan areas.xlsx': 'CDAU_clinical_3', 'C-Vansteelandt2 96 scan areas.xlsx': 'CDAU_clinical_4', 'C-Klein 72 scan areas.xlsx': 'CDAU_clinical_5', 'C-ATCC-CDAL 96 scan areas.xlsx': 'CDAL_ATCC_90029', 'C-95690277 96 scan areas.xlsx': 'CDDU_clinical', 'C-ATCC-CDTR3 96 scan areas.xlsx': 'CDTR_IQC', 'C-96299088 96 scan areas.xlsx': 'CDTR_clinical', 'C-ATCC-CDPA 96 scan areas.xlsx': 'CDPA_ATCC_22019', 'C-ATCC-CDGL 96 scan areas.xlsx': 'CDGL_ATCC_90030', 'C-94768530-CDGL 96 scan areas.xlsx': 'CDGL_clinical_1', 'C-95738583 96 scan areas.xlsx': 'CDGL_clinical_2', 'C-CDKR-IQC 96 scan areas.xlsx': 'CDKR_ATCC_6258', 'C-94878906-CDKR 96 scan areas.xlsx': 'CDKR_clinical'}

rita_dict = {
    'ASFU_R_TR34_3': {'A': 'A7', 'B': 'B2', 'C': 'C4', 'D': 'D0', 'E': 'E2', 'F': 'Z0'},
    'ASFU_R_TR34_4': {'A': 'A6', 'B': 'B0', 'C': 'C4', 'D': 'D0', 'E': 'E0', 'F': 'Z0'},
    'ASFU_R_TR34_5': {'A': 'A7', 'B': 'B3', 'C': 'C5', 'D': 'D0', 'E': 'E2', 'F': 'Z0'},
    'ASFU_R_TR34_6': {'A': 'A5', 'B': 'B2', 'C': 'C4', 'D': 'D0', 'E': 'E2', 'F': 'Z0'},
    'ASFU_R_TR34_7': {'A': 'A5', 'B': 'B2', 'C': 'C5', 'D': 'D0', 'E': 'E1', 'F': 'Z0'},
    'ASFU_R_TR34_8': {'A': 'A5', 'B': 'B3', 'C': 'C5', 'D': 'D0', 'E': 'E3', 'F': 'Z0'},
    'ASFU_R_TR34_9': {'A': 'A6', 'B': 'B3', 'C': 'C5', 'D': 'D0', 'E': 'E3', 'F': 'Z0'},
    'ASFU_R_TR34_10': {'A': 'A6', 'B': 'B4', 'C': 'C4', 'D': 'D0', 'E': 'E3', 'F': 'Z0'},
    'ASFU_R_TR34_11': {'A': 'A6', 'B': 'B4', 'C': 'C4', 'D': 'D0', 'E': 'E3', 'F': 'Z0'},
    'ASFU_R_TR34_12': {'A': 'A6', 'B': 'B0', 'C': 'C3', 'D': 'D0', 'E': 'E1', 'F': 'Z0'},
    'ASFU_R_TR46_14': {'A': 'A6', 'B': 'B0', 'C': 'C6', 'D': 'D6', 'E': 'E0', 'F': 'Z0'},
    'ASFU_R_TR46_19': {'A': 'A5', 'B': 'B0', 'C': 'C3', 'D': 'D0', 'E': 'E0', 'F': 'Z0'},
    'ASFU_R_TR46_15': {'A': 'A6', 'B': 'B0', 'C': 'C4', 'D': 'D0', 'E': 'E0', 'F': 'Z0'},
    'ASFU_R_TR46_16': {'A': 'A5', 'B': 'B4', 'C': 'C5', 'D': 'D0', 'E': 'E2', 'F': 'Z0'},
    'ASFU_R_TR46_20': {'A': 'A6', 'B': 'B0', 'C': 'C3', 'D': 'D0', 'E': 'E0', 'F': 'Z0'},
    'ASFU_R_TR46_17': {'A': 'A5', 'B': 'B0', 'C': 'C5', 'D': 'D3', 'E': 'Z0', 'F': 'Z0'},
    'ASFU_R_TR46_21': {'A': 'A5', 'B': 'B0', 'C': 'C4', 'D': 'D6', 'E': 'E0', 'F': 'Z0'}}

MIC_dict_C_Alkandri_feb_instead_of_nov = {'CDAU_clinical_1': {'A': 'A5', 'B': 'B9', 'C': 'C0', 'D': 'D9', 'E': 'E5', 'F': 'F6', 'G': 'G3', 'H': 'H7'}, 'CDAU_clinical_2': {'A': 'A4', 'B': 'B9', 'C': 'C3', 'D': 'D6', 'E': 'E3', 'F': 'F5', 'G': 'G0', 'H': 'H6'}, 'CDAU_clinical_3': {'A': 'A4', 'B': 'B9', 'C': 'C5', 'D': 'D7', 'E': 'E1', 'F': 'F6', 'G': 'G2', 'H': 'H0'}, 'CDAU_clinical_4': {'A': 'A5', 'B': 'B7', 'C': 'C3', 'D': 'D8', 'E': 'E5', 'F': 'F7', 'G': 'G1', 'H': 'H2'}, 'CDAU_clinical_5': {'A': 'A5', 'B': 'B9', 'C': 'C2', 'D': 'D5', 'E': 'E5', 'F': 'F4', 'G': 'G1', 'H': 'H8'}, 'CDGL_clinical_1': {'A': 'A5', 'B': 'B13', 'C': 'C6', 'D': 'D4', 'E': 'E8', 'F': 'F5', 'G': 'G5', 'H': 'H10'}, 'CDKR_clinical': {'A': 'A4', 'B': 'B5', 'C': 'C5', 'D': 'D7', 'E': 'E9', 'F': 'F7', 'G': 'G3', 'H': 'H7'}, 'CDPA_ATCC_22019': {'A': 'A5', 'B': 'B9', 'C': 'C9', 'D': 'D9', 'E': 'E4', 'F': 'F8', 'G': 'G7', 'H': 'H4'}, 'CDAL_ATCC_90029': {'A': 'A5', 'B': 'B6', 'C': 'C13', 'D': 'D10', 'E': 'E13', 'F': 'F10', 'G': 'G10', 'H': 'H13'}, 'CDTR_IQC': {'A': 'A5', 'B': 'B10', 'C': 'C8', 'D': 'D8', 'E': 'E8', 'F': 'F8', 'G': 'G9', 'H': 'H10'}, 'CDAU_clinical_clade_IV': {'A': 'A5', 'B': 'B9', 'C': 'C9', 'D': 'D9', 'E': 'E6', 'F': 'F7', 'G': 'G7', 'H': 'H8'}, 'CDAU_clinical_clade_III': {'A': 'A5', 'B': 'B8', 'C': 'C0', 'D': 'D0', 'E': 'E3', 'F': 'F0', 'G': 'G0', 'H': 'H2'}, 'CDAU_CDC_clade_II': {'A': 'A6', 'B': 'B9', 'C': 'C9', 'D': 'D10', 'E': 'E9', 'F': 'F10', 'G': 'G6', 'H': 'H9'}, 'CDAU_CDC_clade_I': {'A': 'A6', 'B': 'B10', 'C': 'C9', 'D': 'D9', 'E': 'E3', 'F': 'F8', 'G': 'G7', 'H': 'H5'}, 'CDAU_CDC_clade_V': {'A': 'A5', 'B': 'B9', 'C': 'C4', 'D': 'D6', 'E': 'E4', 'F': 'F6', 'G': 'G3', 'H': 'H0'}, 'CDTR_clinical': {'A': 'A5', 'B': 'B13', 'C': 'C7', 'D': 'D8', 'E': 'E9', 'F': 'F8', 'G': 'G7', 'H': 'H9'}, 'CDGL_clinical_2': {'A': 'A6', 'B': 'B10', 'C': 'C6', 'D': 'D5', 'E': 'E9', 'F': 'F6', 'G': 'G5', 'H': 'H13'}, 'CDDU_clinical': {'A': 'A6', 'B': 'B13', 'C': 'C10', 'D': 'D10', 'E': 'E13', 'F': 'F13', 'G': 'G8', 'H': 'H13'}, 'CDKR_ATCC_6258': {'A': 'A5', 'B': 'B4', 'C': 'C7', 'D': 'D7', 'E': 'E9', 'F': 'F7', 'G': 'G4', 'H': 'H8'}, 'CDGL_ATCC_90030': {'A': 'A5', 'B': 'B13', 'C': 'C6', 'D': 'D4', 'E': 'E9', 'F': 'F4', 'G': 'G4', 'H': 'H10'}}

# nieuwe inzichten Candida 2 juni 2023: Dus voor Candida’s moet je het tweede phot_dict.py algoritme nemen, die limietwaardes instelt – behalve voor amfoB daar neem je oorspronkelijke fotometrische algoritme – en op die resultaten moet je dan correcties toepassen die je besproken hebt met Katrien.


MIC_dict_C = {'CDAL_ATCC_90029': {'A': 'A5',
                     'B': 'B6',
                     'C': 'C13',
                     'D': 'D10',
                     'E': 'E13',
 ...
 'CDAU_clinical_5': {'A': 'A5',
                     ...
                     'G': 'G1', # G1 ipv G6
                     'H': 'H8'},
 'CDAU_clinical_clade_III': {'A': 'A5', # A
                             'B': 'B8',
                             'C': 'C0',
                             'D': 'D0', # D0 ipv D7
                             'E': 'E3',
 ...
 'CDKR_clinical': {'A': 'A4',
                   ...
                   'G': 'G3',
                   'H': 'H7'},
 'CDPA_ATCC_22019': {'A': 'A5', # A5 ipv A0 (nooit onder threshold)
                     'B': 'B9',
                     'C': 'C9',
                     'D': 'D9',
                     'E': 'E4',
...
# Oorspronkelijk dictionary voor Candida

#MIC_dict_C = {'CDAU_clinical_1': {'A': 'A5', 'B': 'B9', 'C': 'C0', 'D': 'D9', 'E': 'E5', 'F': 'F6', 'G': 'G3', 'H': 'H7'}, 'CDAU_clinical_2': {'A': 'A4', 'B': 'B9', 'C': 'C3', 'D': 'D6', 'E': 'E3', 'F': 'F5', 'G': 'G0', 'H': 'H6'}, 'CDAU_clinical_3': {'A': 'A4', 'B': 'B9', 'C': 'C5', 'D': 'D7', 'E': 'E1', 'F': 'F6', 'G': 'G2', 'H': 'H0'}, 'CDAU_clinical_4': {'A': 'A6', 'B': 'B8', 'C': 'C3', 'D': 'D6', 'E': 'E5', 'F': 'F6', 'G': 'G1', 'H': 'H7'}, 'CDAU_clinical_5': {'A': 'A5', 'B': 'B9', 'C': 'C2', 'D': 'D5', 'E': 'E5', 'F': 'F4', 'G': 'G1', 'H': 'H8'}, 'CDGL_clinical_1': {'A': 'A5', 'B': 'B13', 'C': 'C6', 'D': 'D4', 'E': 'E8', 'F': 'F5', 'G': 'G5', 'H': 'H10'}, 'CDKR_clinical': {'A': 'A4', 'B': 'B5', 'C': 'C5', 'D': 'D7', 'E': 'E9', 'F': 'F7', 'G': 'G3', 'H': 'H7'}, 'CDPA_ATCC_22019': {'A': 'A5', 'B': 'B9', 'C': 'C9', 'D': 'D9', 'E': 'E4', 'F': 'F8', 'G': 'G7', 'H': 'H4'}, 'CDAL_ATCC_90029': {'A': 'A5', 'B': 'B6', 'C': 'C13', 'D': 'D10', 'E': 'E13', 'F': 'F10', 'G': 'G10', 'H': 'H13'}, 'CDTR_IQC': {'A': 'A5', 'B': 'B10', 'C': 'C8', 'D': 'D8', 'E': 'E8', 'F': 'F8', 'G': 'G9', 'H': 'H10'}, 'CDAU_clinical_clade_IV': {'A': 'A5', 'B': 'B9', 'C': 'C9', 'D': 'D9', 'E': 'E6', 'F': 'F7', 'G': 'G7', 'H': 'H8'}, 'CDAU_clinical_clade_III': {'A': 'A5', 'B': 'B8', 'C': 'C0', 'D': 'D0', 'E': 'E3', 'F': 'F0', 'G': 'G0', 'H': 'H2'}, 'CDAU_CDC_clade_II': {'A': 'A6', 'B': 'B9', 'C': 'C9', 'D': 'D10', 'E': 'E9', 'F': 'F10', 'G': 'G6', 'H': 'H9'}, 'CDAU_CDC_clade_I': {'A': 'A6', 'B': 'B10', 'C': 'C9', 'D': 'D9', 'E': 'E3', 'F': 'F8', 'G': 'G7', 'H': 'H5'}, 'CDAU_CDC_clade_V': {'A': 'A5', 'B': 'B9', 'C': 'C4', 'D': 'D6', 'E': 'E4', 'F': 'F6', 'G': 'G3', 'H': 'H0'}, 'CDTR_clinical': {'A': 'A5', 'B': 'B13', 'C': 'C7', 'D': 'D8', 'E': 'E9', 'F': 'F8', 'G': 'G7', 'H': 'H9'}, 'CDGL_clinical_2': {'A': 'A6', 'B': 'B10', 'C': 'C6', 'D': 'D5', 'E': 'E9', 'F': 'F6', 'G': 'G5', 'H': 'H13'}, 'CDDU_clinical': {'A': 'A6', 'B': 'B13', 'C': 'C10', 'D': 'D10', 'E': 'E13', 'F': 'F13', 'G': 'G8', 'H': 'H13'}, 'CDKR_ATCC_6258': {'A': 'A5', 'B': 'B4', 'C': 'C7', 'D': 'D7', 'E': 'E9', 'F': 'F7', 'G': 'G4', 'H': 'H8'}, 'CDGL_ATCC_90030': {'A': 'A5', 'B': 'B13', 'C': 'C6', 'D': 'D4', 'E': 'E9', 'F': 'F4', 'G': 'G4', 'H': 'H10'}}


species_dict_A = {'ASFU_R_TR34_1': 'ASFU', 'ASFU_S_1': 'ASFU', 'A-94277936 60 scan areas.xlsx': 'ASFU', 'ASFU_R_TR34_2': 'ASFU', 'ASFU_R_TR46_18': 'ASFU', 'ASFU_ATCC_204305_S': 'ASFU', 'ASFU_R_TR34_3': 'ASFU', 'ASFU_R_TR34_4': 'ASFU', 'ASFU_R_TR34_5': 'ASFU', 'ASFU_R_TR34_6': 'ASFU', 'ASFU_R_TR34_7': 'ASFU', 'ASFU_R_TR34_8': 'ASFU', 'ASFU_R_TR34_9': 'ASFU', 'ASFU_R_TR34_10': 'ASFU', 'ASFU_R_TR34_11': 'ASFU', 'ASFU_R_TR34_12': 'ASFU', 'ASFU_S_8': 'ASFU', 'A-94742083 96 scan areas.xlsx': 'ASFU', 'ASFU_S_2': 'ASFU', 'ASFU_R_TR46_14': 'ASFU', 'ASFU_R_TR34_13': 'ASFU', 'ASFU_R_unknown_22': 'ASFU', 'ASFU_S_3': 'ASFU', 'ASFU_S_4': 'ASFU', 'ASFU_R_TR46_19': 'ASFU', 'ASFU_S_7': 'ASFU', 'ASFU_S_5': 'ASFU', 'ASFU_S_6': 'ASFU', 'ASFU_R_TR46_15': 'ASFU', 'ASFU_R_TR46_16': 'ASFU', 'ASFU_R_TR46_20': 'ASFU', 'ASFU_R_TR46_17': 'ASFU', 'ASFU_R_TR46_21': 'ASFU', 'ASFU_R_23': 'ASFU'}


species_dict_C = {'CDAU_clinical_1': 'CDAU', 'CDAU_clinical_2': 'CDAU', 'CDAU_clinical_3': 'CDAU', 'CDAU_clinical_4': 'CDAU', 'CDAU_clinical_5': 'CDAU', 'CDGL_clinical_1': 'CDGL', 'CDKR_clinical': 'CDKR', 'CDPA_ATCC_22019': 'CDPA', 'CDAL_ATCC_90029': 'CDAL', 'CDTR_IQC': 'CDTR', 'CDAU_clinical_clade_IV': 'CDAU', 'CDAU_clinical_clade_III': 'CDAU', 'CDAU_CDC_clade_II': 'CDAU', 'CDAU_CDC_clade_I': 'CDAU', 'CDAU_CDC_clade_V': 'CDAU', 'CDTR_clinical': 'CDTR', 'CDGL_clinical_2': 'CDGL', 'CDDU_clinical': 'CDDU', 'CDKR_ATCC_6258': 'CDKR', 'CDGL_ATCC_90030': 'CDGL'}

MIC_dict_A_old = {'A-94329739 60 scan areas.xlsx':
...
MIC_dict_C_old = {'C-Dhondt 96 scan areas.xlsx':
                {'A': 'A5', 'B': 'B9', 'C': 'C0', 'D': 'D9', 'E': 'E5', 'F': 'F6', 'G': 'G3', 'H': 'H7'}, # echinocandine-S
            'C-Alkandri2 96 scan areas.xlsx':
                {'A': 'A4', 'B': 'B9', 'C': 'C3', 'D': 'D6', 'E': 'E3', 'F': 'F5', 'G': 'G0', 'H': 'H6'}, # echinocandine-S 
            'C-Enam 96 scan areas.xlsx':
                {'A': 'A4', 'B': 'B9', 'C': 'C5', 'D': 'D7', 'E': 'E1', 'F': 'F6', 'G': 'G2', 'H': 'H0'}, # MICs staal 21/11 gebruikt, gezien afgelezen 24u; echinocandine-S
            'C-Vansteelandt2 96 scan areas.xlsx':
                {'A': 'A6', 'B': 'B8', 'C': 'C3', 'D': 'D6', 'E': 'E5', 'F': 'F6', 'G': 'G1', 'H': 'H7'}, # MICs staal 19/11 gebruikt, idem; 31/12 correctie A5 naar A6; was typefout
            'C-Klein 72 scan areas.xlsx':
                {'A': 'A5', 'B': 'B9', 'C': 'C2', 'D': 'D5', 'E': 'E5', 'F': 'F4', 'G': 'G1', 'H': 'H8'}, # Geen foto
            'C-94768530-CDGL 96 scan areas.xlsx':
                {'A': 'A5', 'B': 'B13', 'C': 'C6', 'D': 'D4', 'E': 'E8', 'F': 'F5', 'G': 'G5', 'H': 'H10'}, # 31/12; B11 naar B13, was typefout
            'C-94878906-CDKR 96 scan areas.xlsx':
                {'A': 'A4', 'B': 'B5', 'C': 'C5', 'D': 'D7', 'E': 'E9', 'F': 'F7', 'G': 'G3', 'H': 'H7'}, 
            'C-ATCC-CDPA 96 scan areas.xlsx':
                {'A': 'A5', 'B': 'B9', 'C': 'C9', 'D': 'D9', 'E': 'E4', 'F': 'F8', 'G': 'G7', 'H': 'H4'}, # Wat twijfel amfo-B MIC, 1 mg/l of 0.5 mg/L - geen foto
            'C-ATCC-CDAL 96 scan areas.xlsx':
                 {'A': 'A5', 'B': 'B6', 'C': 'C13', 'D': 'D10', 'E': 'E13', 'F': 'F10', 'G': 'G10', 'H': 'H13'}, # MICs afgelezen op plaat 54u geïncubeerd -te vergelijken met target MICs voor ATCC (eerdere ingave waren andere MICs - quid?)
            'C-ATCC-CDTR3 96 scan areas.xlsx':
                {'A': 'A5', 'B': 'B10', 'C': 'C8', 'D': 'D8', 'E': 'E8', 'F': 'F8', 'G': 'G9', 'H': 'H10'}, # afgelezen op plaat 34 u geïncubeed - typefout: C-F aflezen als 8, doch ingegeven als 7: gecorrigeerd 1/1
            'C-MCC3-10 96 scan areas.xlsx':
                {'A': 'A5', 'B': 'B9', 'C': 'C9', 'D': 'D9', 'E': 'E6', 'F': 'F7', 'G': 'G7', 'H': 'H8'}, # 0.66 mcF; afgelezen 26u20. Amfo-B MIC dubieus.
            'C-MRU224 96 scan areas.xlsx':
                {'A': 'A5', 'B': 'B8', 'C': 'C0', 'D': 'D0', 'E': 'E3', 'F': 'F0', 'G': 'G0', 'H': 'H2'}, # Amfo-B MIC dubieus. B8 was B0 (typefout?). MOEILIJKE AFLEZING AZOLES: schommelen rond 50% inhibitie - 0.5 mcF; afgelezen 23u30
            ...
            'C-ML315-AR1037 96 scan areas.xlsx':
                {'A': 'A5', 'B': 'B9', 'C': 'C4', 'D': 'D6', 'E': 'E4', 'F': 'F6', 'G': 'G3', 'H': 'H0'}, # 0.62 mcF (of 0.52?); afgelezen 23u30. Amfo-B MIC dubieus.
            'C-96299088 96 scan areas.xlsx':
                {'A': 'A5', 'B': 'B13', 'C': 'C7', 'D': 'D8', 'E': 'E9', 'F': 'F8', 'G': 'G7', 'H': 'H9'}, # 0.56 mcF; afgelezen 22u30; 1/1 B11 naar B13; CDTR
            'C-95738583 96 scan areas.xlsx':
                {'A': 'A6', 'B': 'B10', 'C': 'C6', 'D': 'D5', 'E': 'E9', 'F': 'F6', 'G': 'G5', 'H': 'H13'}, # 0.51 mcF; afgelezen 26u; CDGL
            'C-95690277 96 scan areas.xlsx':
                {'A': 'A6', 'B': 'B13', 'C': 'C10', 'D': 'D10', 'E': 'E13', 'F': 'F13', 'G': 'G8', 'H': 'H13'}, # geen foto; amfo-B MIC op curve lijkt A8, maar is net niet onder cutoff 95% inhibitie, vandaar A6; afgelezen 25u
            'C-CDKR-IQC 96 scan areas.xlsx':
                {'A': 'A5', 'B': 'B4', 'C': 'C7', 'D': 'D7', 'E': 'E9', 'F': 'F7', 'G': 'G4', 'H': 'H8'}, # amfo-B MIC dubieus.
            'C-ATCC-CDGL 96 scan areas.xlsx':
                {'A': 'A5', 'B': 'B13', 'C': 'C6', 'D': 'D4', 'E': 'E9', 'F': 'F4', 'G': 'G4', 'H': 'H10'}} 
...
species_dict_C_old = {'C-Dhondt 96 scan areas.xlsx': 'CDAU',
